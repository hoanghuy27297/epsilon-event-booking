...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<epsilon-big-input-action></epsilon-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<epsilon-big-input-action [disabled]="true"></epsilon-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<epsilon-big-input-action fontSet="fas" fontIcon="fa-trash"></epsilon-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<epsilon-big-input-action label="delete"></epsilon-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<epsilon-big-input-action (action)="actionHandler()"></epsilon-big-input-action>`;
    fixture = createHostComponent(template);
